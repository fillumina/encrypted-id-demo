 ...
 * <p>
 * The most known identifier is the <a href='https://docs.jboss.org/hibernate/orm/4.3/manual/en-US/html/ch20.html#performance-collections-mostefficentinverse'>
 * UUID</a> which has the disadvantage of being 16 bytes long (128 bits) and because of that it wastes
 * precious memory and disk space on the databases involved. There are several kind of universal
 * identifier which are more compact in size and so better suited for the purpose, I have used
